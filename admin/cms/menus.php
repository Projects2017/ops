...
?>
	<li class="dd-item dd3-item" data-id="<?php=$row['cms_menu_item_id']?>">

    <div class="dd-handle dd3-handle">Drag</div><div class="dd3-content"><?php=$row['menu_text']?> &nbsp;<a class="btn btn-xs btn-default btn-edit-ivr-row" data-id="1" href="#edit" style="border-radius:12px;font-size:10px;" data-original-title="" title=""><i class="fa fa-pencil"></i></a>  <a class="delete_ivr_row" href="#" data-id="<?php=$row['cms_menu_item_id']?>" data-original-title="" title="">Delete</a>
	<a href="edit_menu_item.php?cms_menu_item_id=<?php=$row['cms_menu_item_id']?>">Edit</a>
    </div> 
    ...
    <?php
		...
		while ($rowLevel1 = mysql_fetch_array($curLevel1)) {
			?>
		<li class="dd-item dd3-item" data-id="<?php=$rowLevel1['cms_menu_item_id']?>">
		<div class="dd-handle dd3-handle">Drag</div><div class="dd3-content"><?php=$rowLevel1['menu_text']?> &nbsp;<a class="btn btn-xs btn-default btn-edit-ivr-row" data-id="1" href="#edit" style="border-radius:12px;font-size:10px;" data-original-title="" title=""><i class="fa fa-pencil"></i></a>  <a class="delete_ivr_row" href="#" data-id="<?php=$rowLevel1['cms_menu_item_id']?>" data-original-title="" title="">Delete</a>
		<a href="edit_menu_item.php?cms_menu_item_id=<?php=$rowLevel1['cms_menu_item_id']?>">Edit</a>
		</div> 
		</li>
			<?php
		}
