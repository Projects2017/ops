...
<B>Rate of Sale:</B><BR>
<FORM name='rate_form' method='get' action='<?php echo $_SERVER['PHP_SELF']; ?>'>
...
?>
<BR><BR>
Group Result By Vendor &amp; Form<INPUT type='checkbox' id='group_forms' name='group_forms' value='Y' <?php if ($group_forms) echo "CHECKED"; ?>>
<BR><BR>
Choose a vendor:
