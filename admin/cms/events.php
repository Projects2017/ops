...
?>
    ...
    <td class="text_12"><?php=date("m/d/Y",strtotime($row['start_date']))?></td>
    <td class="text_12"><?php=date("m/d/Y",strtotime($row['end_date']))?></td>
    <td><a href="edit_event.php?cms_event_id=<?php=$row['cms_event_id']?>">Edit</a> &nbsp;|&nbsp; <a href="javascript:confirmDelete(<?php=$row['cms_event_id']?>)">Delete</a></td>
  </tr>
<?php
}
?>
