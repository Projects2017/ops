...
//$send_to = "Will <will@element9.net>";
...
$subject = "PMD Damage Claim/%name_from_req%/%Vendor_req%/%Item_req%";
//$subject = "";
...
$database_enabled = 1;
$database_file = '../docs/damage.csv'; //disable for testing
...
$autoresponder_subject = "PMD Damage Claim (autoresponse)";
$autoresponder_message = <<<MSG
Hi %name_from_req%,

Thank you for submitting your damage report. Here is the information you submitted to us:
NAME:             %name_from_req%
EMAIL:            %email_from%
VENDOR:           %Vendor_req%
PO#:              %PO#_reqnum%
