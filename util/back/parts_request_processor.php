...
$send_to = "Shelly Graham <shellygraham@pmdfurniture.com>";  //Damage and Claims Supervisor - send here in prod
...
//
$send_cc = array('pmdfurniture@makahilahila.net', 'garydavis@pmdfurniture.com');  //webmistress - testing purposes

// Subject. if empty, use value from form ('subject' field)
$subject = "PMD PARTS REQUEST FORM";
//$subject = "";
...
//$database_file = 'forms/parts.csv';      //enable for testing
...
We will be getting back with you within 3 business days regarding your request.
