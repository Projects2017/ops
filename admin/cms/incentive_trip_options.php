...
?>
	...
	<tr valign="top">
		...
		<td class="text_12"><input style="width:100%;" type="text" name="incentive_trip_countdown_date" id="incentive_trip_countdown_date" value="<?php=date("m/d/Y",strtotime($incentive_trip_countdown_date))?>" class="datepicker"/><br></td>
	</tr>

	<tr valign="top">
		<td class="fat_black_12">Starting Date for Purchases</td>
		<td class="text_12"><input style="width:100%;" type="text" name="incentive_trip_initial_sales_date" id="incentive_trip_initial_sales_date" value="<?php=date("m/d/Y",strtotime($incentive_trip_initial_sales_date))?>" class="datepicker"/><br></td>
	</tr>

	<tr valign="top">
		<td class="fat_black_12">Sales Floor for Purchases</td>
		<td class="text_12"><input style="width:100%;" type="text" name="incentive_trip_sales_floor" id="incentive_trip_sales_floor" value="<?php=$incentive_trip_sales_floor?>"/><br></td>
	</tr>

	<tr valign="top">
		<td class="fat_black_12">Trip Description Line 1</td>
		<td class="text_12"><input style="width:100%;" type="text" name="incentive_trip_line_1" id="incentive_trip_line_1" value="<?php=$incentive_trip_line_1?>"/><br></td>
	</tr>

	<tr valign="top">
		<td class="fat_black_12">Trip Description Line 2</td>
		<td class="text_12"><input style="width:100%;" type="text" name="incentive_trip_line_2" id="incentive_trip_line_2" value="<?php=$incentive_trip_line_2?>"/><br></td>
	</tr>

	<tr valign="top">
		<td class="fat_black_12">Trip Description Line 3</td>
		<td class="text_12"><input style="width:100%;" type="text" name="incentive_trip_line_3" id="incentive_trip_line_3" value="<?php=$incentive_trip_line_3?>"/><br></td>
	</tr>
