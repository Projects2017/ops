...
?>
    <tr bgcolor="#FFFFFF">
    <td class="text_12"><?php=$row['slider_name']?></td>
    <td><a href="edit_slider.php?cms_slider_id=<?php=$row['cms_slider_id']?>">Edit</a> | <a href="manage_slides.php?cms_slider_id=<?php=$row['cms_slider_id']?>">Manage Slides</a></td>
  </tr>
<?php
}
?>
