...
<table border="0" cellspacing="0" cellpadding="5" align="left" width="760">
    ...
    while ($row = mysql_fetch_array($query)) {
        ?>
        <tr bgcolor="#FFFFFF">
            <td class="text_12"><?=$row['page_title']?></td>
            <td><a href="edit_page.php?cms_page_id=<?=$row['cms_page_id']?>">Edit</a> &nbsp;|&nbsp; <a href="/leaderboard/index.php?id=<?=$row['cms_page_id']?>" target="_blank">View</a> &nbsp;|&nbsp; <a href="edit_page.php?cms_page_id=<?=$row['cms_page_id']?>&copy=1">Copy</a> &nbsp;|&nbsp; <a href="javascript:confirmDelete(<?=$row['cms_page_id']?>)">Delete</a></td>
        </tr>
        <?php
    }
    ?>
