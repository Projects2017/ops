...
$title = "PMD File Browser";// Title (may contain HTML tags)
...
$uploadmaxsize = 20388608;          // Max file size for uploads (check your php.ini)
...
$realmname = "PMD File Browser";  // Realm name for use with $authmethod = "realm"
...
// down on line 897 is where to restrict certain users to specific directories
// it's an ugly fix.. but hey.. it works - Goody 04-19-2004
...
$basedir = "../../.";          // Base directory = custom directory (UNIX)
...
// ******* HERE IS WHERE TO RESTRICT USER TO CERTAIN DIRECTORIES *******
// copy next three lines, add under original lines, change according to your needs
if ($HTTP_SESSION_VARS["WFBUSER"] == "pmd21") {  //added to keep contain pmd 21 user to this dir
	$basedir = "../../docs";          // Base directory = custom directory (UNIX)
}
