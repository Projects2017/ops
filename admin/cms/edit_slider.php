...
?>
	...
	<form action="" method="POST" id="frmMain">
		<input type="hidden" name="cms_slider_id" value="<?php=$row['cms_slider_id']?>"/>

	<table border="0" cellspacing="5" cellpadding="0" width="90%">
	<tr valign="top">
		<td class="fat_black_12">Slider Name</td>
		<td class="text_12"><input style="width:100%;" type="text" name="slider_name" id="slider_name" value="<?php=$row['slider_name']?>"><br></td>
	</tr>
