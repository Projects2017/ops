...
<table border="0" cellspacing="0" cellpadding="5" align="left" width="760">
    ...
    while ($row = mysql_fetch_array($query)) {
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td><a href="edit_resource_category.php?cms_resource_category_id=<?=$row['cms_resource_category_id']?>">Edit</a> &nbsp;|&nbsp; <a href="javascript:confirmDelete(<?=$row['cms_resource_category_id']?>)">Delete</a></td>
        </tr>
        <?php
    }
    ?>
