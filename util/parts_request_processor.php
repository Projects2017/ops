...
$subject = "PMD Parts Claim/%name_from_req%/%Vendor_req%/%Item_req%";
//$subject = "";
...
$database_enabled = 1;
$database_file = '../docs/parts.csv'; //disable for testing
...
Thank you for submitting your parts request. Here is the information you submitted to us:
NAME:             %name_from_req%
EMAIL:            %email_from%
VENDOR:           %Vendor_req%
PO#:              %PO#_reqnum%
ITEM:             %Item_req%
SHIPPING ADDRESS: %Shipping_Address_req%
PARTS REQUESTED:  %Parts_requested_req%
...
Parts Request Form info submitted:
$fields
--------------------
