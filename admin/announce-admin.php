...
if ($actionmode == 'sendannouncement') {
	...
	<BLOCKQUOTE class="article">
		    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>?action=sendannouncementproc">
			<table border="0" cellspacing="0" cellpadding="5" align="left" width="100%">
			  <tr bgcolor="#CCCC99">
				<td colspan=2 class="fat_black_12"><input type='text' name='subject' maxlength='100' size="100" value="<?php echo htmlentities($announcement['subject']); ?>"></td>
			  </tr>
			  <tr>
		...
		<p align="center">[<a href="<?php echo $_SERVER['PHP_SELF']; ?>">Back to Announcements List</a>]</p>
	<?php
	...
	?>
		...
		<BLOCKQUOTE class="article">
		    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>?action=upannouncement&announcement=<?php echo $announcement['id']; ?>">
			<table border="0" cellspacing="0" cellpadding="5" align="left" width="100%">
			  <tr bgcolor="#CCCC99">
				<td class="fat_black_12"><input type='text' name='subject' maxlength='100'  size="100" value="<?php echo htmlentities($announcement['subject']); ?>"></td>
			  </tr>
			  <tr>
				<td class="text_12">
					<textarea name='text' COLS=100 ROWS=6><?php
	...
	foreach($list as $item) {
		echo '<tr>';
		  ...
		  echo "<A HREF='".$SERVER['PHP_SELF']."?action=delannouncement&announcement=".$item['id'].'\' ';
					?>onClick="return confirm('Are you sure you wish to delete this announcement?');"><?php
