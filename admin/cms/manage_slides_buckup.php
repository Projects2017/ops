...
<table width="760">
    <tr>
        ...
        <td align="right">
            <a href="edit_slide.php?cms_slider_id=<?=$_REQUEST['cms_slider_id']?>">+ Add New Slide</a>
        </td>
    </tr>
</table>
...
<table border="0" cellspacing="0" cellpadding="5" align="left" width="760">
    ...
    while ($row = mysql_fetch_array($query)) {
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td class="text_12"><?=$row['duration']?> sec</td>
            <td><a href="edit_slide.php?cms_slider_slide_id=<?=$row['cms_slider_slide_id']?>">Edit</a> | <a href="edit_slide.php?a=delete&cms_slider_slide_id=<?=$row['cms_slider_slide_id']?>&cms_slider_id=<?=$row['cms_slider_id']?>">Delete</a></td>
        </tr>
        <?php
    }
    ?>
