...
// w00t!
// chcsvexport.php
// script to export Costco orders to CSV
...
<html>
<head>
	<title>Shipping CSV Export Queue - Costco Orders</title>
...
?>
<p class="title">Shipping CSV Export Queue<br />
Costco Orders Only<br /><?php
...
?>
<form name="settings_form" method="post" action="chcsvexport.php">
...
?>
		...
		<tr>
			<td align="center"><a href="chcsvfinalize.php?type=pending&mode=<?php if ($show_type == 'po') echo 'salesord'; else echo 'soi'; ?>">Preview Queued CSV</a></td>
			<td align="center"><a href="chcsvfinalize.php?mode=<?php if ($show_type == 'po') echo 'salesord'; else echo 'soi'; ?>">Download Final CSV</a></td>
		</tr>
	</table>
</form>
<?php
...
$queue = getCSVQueue($arg, true); // true = get CH orders only
unset($arg);
