...
<H3>Damage and Claims Forms Submitted</H3><BR>
...
<TH VALIGN=TOP ALIGN=CENTER WIDTH=30 BGCOLOR=#CCCC99><b><a href="<?php $_SERVER['PHP_SELF'] ?>?order=purchase_date">Purchase<BR>date:</a></b></TH>
<TH VALIGN=TOP ALIGN=CENTER WIDTH=150 BGCOLOR=#CCCC99><b><a href="<?php $_SERVER['PHP_SELF'] ?>?order=item">Item:</a></b></TH>
...
$records = loadcsv(array('name_from','email_from','vendor','PO','purchase_date','item','trucking_company','carton_damage','description','email_on','timestamp'),'../docs/damage.csv');
if ($_GET[order]) {
  ...
  foreach ($records as $record) {
      echo "<TR><TD WIDTH=200><B>".$record['name_from']."</B></TD><TD WIDTH=150>".$record['vendor']."</TD><TD WIDTH=25>".$record['PO']."</TD><TD WIDTH=30>".$record['purchase_date']."</TD><TD WIDTH=155>".$record['item']."</TD><TD WIDTH=100>".$record['trucking_company']."</TD><TD WIDTH=75>".$record['carton_damage']."</TD><TD WIDTH=55>".$record['timestamp']."</TD></TR>";
