...
?>
	...
	<form action="" method="POST" id="frmMain" enctype="multipart/form-data">
		<input type="hidden" name="cms_countdown_id" value="<?php=$row['cms_countdown_id']?>"/>

	<table border="0" cellspacing="5" cellpadding="0" width="90%">

	<tr valign="top">
		<td class="fat_black_12">Countdown Date/Time</td>
		<td class="text_12"><input style="width:100%;" type="text" name="cms_countdown_datetime" id="cms_countdown_datetime" value="<?php=$row['cms_countdown_datetime']?>"><br></td>
	</tr>
