...
?>
  ...
  <table border="0" cellspacing="0" cellpadding="5" width="760">
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td><p><a href="salestats_view.php">Daily</a> | <a href="<?php echo $_SERVER['PHP_SELF']; ?>?type=weekly">Weekly</a> | <a href="<?php echo $_SERVER['PHP_SELF']; ?>?type=monthly">Monthly</a>
        | <a href="<?php echo $_SERVER['PHP_SELF']; ?>?type=ytd">Year-to-Date</a> | <a href="salestats_filter.php">Custom</a></p></td>
    </tr>
  </table>
...
/* =========== PRINT REPORT =========== */
	...
	if (secure_is_manager()) {
		$gSaleStats->GetSums(db_user_filterlist($filter), $start, $end, $resolution);
		$gSaleStats->Rank('mUserLastName',0);
	} else {
