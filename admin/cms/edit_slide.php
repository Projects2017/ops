...
?>
	...
	<form action="/admin/cms/edit_slide.php" method="POST" id="frmMain">
		<input type="hidden" name="cms_slider_slide_id" value="<?php=$row['cms_slider_slide_id']?>"/>
		<input type="hidden" name="cms_slider_id" value="<?php=$intSliderID?>"/>
	...
	<tr valign="top">
		...
		<td class="text_12"><input style="width:100%;" type="text" name="duration" id="duration" value="<?php=$row['duration']?>"><br></td>
	</tr>

	<tr valign="top">
		<td class="fat_black_12">Display Order</td>
		<td class="text_12"><input style="width:100%;" type="text" name="display_order" id="display_order" value="<?php=$row['display_order']?>"><br></td>
	</tr>
	...
	<tr valign="top">
		...
		<div class="popup-example" style="width:100%;" >
			...
			<input style="width:450px;" type="text" name="image_url" id="image_url" value="<?php=$row['image_url']?>">
			</div>
	...
	<tr valign="top">
		...
		<td class="text_12"><input style="width:100%;" type="text" name="link" id="link" value="<?php=$row['link']?>"><br></td>
	</tr>
