...
?>
	  <table border="1" cellspacing="0" cellpadding="4" bgcolor="#FFFFFF">
        <tr bgcolor="#CCCC99"> 
          <?php if($fields[0]) { ?>
          <td class="fat_black_12">Part #</td>
          <?php } ?>
          <?php if($fields[1]) { ?>
          <td class="fat_black_12">Description</td>
          <?php } ?>
          <?php if($fields[3]) { ?>
          <td class="fat_black_12">Size</td>
          <?php } ?>
          <?php if($fields[4]) { ?>
          <td class="fat_black_12">Color</td>
          <?php } ?>
          <?php if($fields[2]) { ?>
          <td class="fat_black_12">Price</td>
          <?php } ?>
          <?php if($fields[5]) { ?>
          <td class="fat_black_12">Set</td>
          <td width="75" class="fat_black_12">Qty</td>
          <?php } ?>
          <?php if($fields[6]) { ?>
          <td class="fat_black_12">Matt</td>
          <td width="75" class="fat_black_12">Qty</td>
          <?php } ?>
          <?php if($fields[7]) { ?>
          <td class="fat_black_12">Box</td>
          <?php } ?>
          <td width="75" class="fat_black_12">Qty</td>
          <td width="75" class="fat_black_12">Total</td>
        </tr>
        <?php
...
while($result = mysql_fetch_array($query))
{
	...
	{
?>	
		<tr><td align="center" colspan="<?php echo $numfields + 1?>" class="fat_black_12"><?php echo $newheader ?></td></tr>
<?php		
		$oldheader = $newheader;
	}
...
?>
        <tr> 
          <td align="right" colspan=<?php echo $numfields; ?> class="text_12">INVOICE TOTAL: </td>
