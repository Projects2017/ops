...
<h1>Pages</h1>
	...
	<form action="" method="POST" id="frmMain">
		...
		<input type="hidden" name="cms_page_id" value="<?php=$row['cms_page_id']?>"/>
		<?php } ?>

	<table border="0" cellspacing="5" cellpadding="0" width="90%">
	<tr valign="top">
		<td class="fat_black_12">Page Title</td>
		<td class="text_12"><input style="width:100%;" type="text" name="page_title" id="page_title" value="<?php=$page_title?><?php if (!empty($_REQUEST['copy'])){ ?> (Copy)<?php } ?>"><br><br></td>
	</tr>
	<tr valign="top">
	...
	<tr valign="top">
		...
		<td class="text_12">
			<textarea style="width:100%;height:350px;" name="page_content" id="page_content"><?php=$content?></textarea>
		</td>
	</tr>
