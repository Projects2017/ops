...
if($content['template_id'] == 2){
...
} else if($content['template_id'] == 6){
    include 'template_blank.php';
} else if($content['template_id'] == 8){
	...
	} else if($id == 'incentive_trip') {
	    include 'template_incentive_trip.php';    
	} else {
		if ($content['cms_page_id'] == 15){ //events
		    include 'template_events.php';
		} else {
