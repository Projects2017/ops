...
$subject = "PMD Refused Claim/%name_from_req%/%Vendor_req%/%Item_req%";
//$subject = "";
...
$database_enabled = 1;
$database_file = '../docs/refused.csv'; //disable for testing
//$database_file = 'damage_test.csv';      //enable for testing
...
$redirect_url = '/request_submitted.html';
...
Thank you for submitting your Vendor Refused Claim Request. Here is the information you submitted to us:
NAME:             %name_from_req%
EMAIL:            %email_from%
VENDOR:           %Vendor_req%
PO#:              %PO#_reqnum%
TRUCKING COMPANY: %Trucking_company_req%
CARTON DAMAGE:    %Carton_damage_req%
ITEMS REFUSED::   %Item_Refused_req%

PURCHASE DATE:    %Purchase_date_req%
DESCRIPTION:      %Description_of_damage_req%


We will be getting back with you within 3 business days regarding your claim.

Shelly Graham - Dealer Support - Damage and Claims Supervisor
614-442-5645
614-538-0606 (fax)
shellygraham@pmdfurniture.com

Gary Davis - Dealer Support - Damage and Claims
614-538-1720
614-538-0606 (fax)
garydavis@pmdfurniture.com
--
MSG;
...
Vendor Refused Claim info submitted:
$fields
--------------------
...
EOF;
    ...
    preg_match_all('/%(.+?)%/', $_subject, $out);
    $s_vars = $out[1]; //field list to substitute
    foreach ($s_vars as $k)
        $_subject = str_replace("%".$k."%", $vars[$k], $_subject);
    //
