...
$month_start    = date($_REQUEST['y']."-1-1");
$month_end    = date($_REQUEST['y']."-12-31");

$manager = '';
if(isset($_REQUEST['mgr']))
    $manager = $_REQUEST['mgr'];

$mattress_month = BigBoard::getLeaders($month_start, $month_end, $_REQUEST['t'],$_REQUEST['ttl'],$manager);
