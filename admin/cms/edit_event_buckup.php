...
if ($_POST){
    ...
    <form action="" method="POST" id="frmMain" enctype="multipart/form-data">
        <input type="hidden" name="cms_event_id" value="<?=$row['cms_event_id']?>"/>
        ...
        <table border="0" cellspacing="5" cellpadding="0" width="90%">
            ...
            <tr valign="top">
                ...
                <td class="text_12"><input style="width:100%;" type="text" name="description" id="description" value="<?=$row['description']?>"><br></td>
            </tr>

            <tr valign="top">
                <td class="fat_black_12">Event Start Date</td>
                <td class="text_12"><input class="datepicker" style="width:100%;" type="text" name="start_date" id="start_date" value="<?=$startDate?>"><br></td>
            </tr>

            <tr valign="top">
                <td class="fat_black_12">Event End Date</td>
                <td class="text_12"><input class="datepicker" style="width:100%;" type="text" name="end_date" id="end_date" value="<?=$endDate?>"><br></td>
            </tr>
