        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    <a href="users.php?action=view" type="button" class="btn btn-primary btn-md"><span class="icon-plus-2"></span> Add New Dealer</a>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    <a href="report-dealeraccess.php" type="button" class="btn btn-primary btn-md"><span class="icon-note-1"></span> Dealer Access Report</a>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    <a href="/editest.php" type="button" class="btn btn-primary btn-md"><span class="icon-plus-2"></span> EDI Testing</a>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    <a href="login-sessions.php" type="button" class="btn btn-primary btn-md"><span class="icon-plus-2"></span> Login Sessions</a>
                </div>
                <?php } ?>
            </div>
        </div>
