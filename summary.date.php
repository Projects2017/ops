...
<table border="0" cellspacing="0" cellpadding="5" width="70%" align="center">
  <tr>
    <td colspan="8" align="center"><h3>Summary for <?php echo getUserName($userid); ?></h3></td>
...
<?php } /* end if !$nopages */ ?>
  <tr bgcolor="#fcfcfc">
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF" class="fat_black_12" colspan="2"><?php echo makeThisLookLikeMoney($credit_limit); ?></td>
