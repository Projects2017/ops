...
?>
	...
	<form action="" method="POST" id="frmMain">
		<input type="hidden" name="cms_menu_item_id" value="<?php=$row['cms_menu_item_id']?>"/>

	<table border="0" cellspacing="5" cellpadding="0" width="90%">
	<tr valign="top">
		<td class="fat_black_12">Menu Text</td>
		<td class="text_12"><input style="width:100%;" type="text" name="menu_text" id="menu_text" value="<?php=$row['menu_text']?>"><br></td>
	</tr>
	...
	<tr valign="top">
		...
		<input style="width:100%;" type="text" name="menu_link" id="menu_link" value="<?php=$row['menu_link']?>"><br>
