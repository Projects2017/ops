...
namespace ZebraPrinter
{
    ...
    // grbbed from http://support.microsoft.com/kb/322091
    ...
    public class ZebraPrint : AxInterface
    {
        // public methods

        // writes a command to the printer
        public void Write(string rawLines)
        {
            String pName;
            pName = RawPrinterHelper.AskForPrinter();
            ...
            //    //if(rawLines != null) RawPrinterHelper.SendStringToPrinter("ZDesigner LP 2844", rawLines);
            //    if (rawLines != null) RawPrinterHelper.SendStringToPrinter(pd.PrinterSettings.PrinterName, rawLines);
            // }
        }
    }
}
