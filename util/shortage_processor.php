...
$subject = "PMD Shortage Claim/%name_from_req%/%Vendor_req%/%Item_req%";
//$subject = "";
...
Thank you for submitting your Shortage Claim Request. Here is the information you submitted to us:
NAME:                   %name_from_req%
EMAIL:                  %email_from%
VENDOR:                 %Vendor_req%
TRUCKING COMPANY:       %Trucking_company_req%
PO#:                    %PO#_reqnum%
REQUESTED:              %Credit_or_Backorder_req%
ITEMS SHORTED:          %Items_shorted_req%
SHORTED_ON_ORIG_PO:     %SHORTED_ON_ORIG_PO_req%
SHORTED_ON_PACKING_LIST:%SHORTED_ON_PACKING_LIST_req%
