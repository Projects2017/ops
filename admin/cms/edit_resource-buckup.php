                ...
                <td class="text_12">
                    <select name="cms_resource_category_id">
                        <?php while ($objCategory = mysql_fetch_array($arrCategories)){?>
                            <option value="<?=$objCategory['cms_resource_category_id']?>"<?php if ($objCategory['cms_resource_category_id']==$row['cms_resource_category_id']) echo " selected";?>><?=$objCategory['title']?></option>
                        <?php } ?>
                    </select>
                </td>
            </tr>
